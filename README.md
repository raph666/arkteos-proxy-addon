...
| Nb cycles compresseur | 0 à 999 999 |
...
| Voltage DC | 5 V | 60s |
| Débit eau primaire | 10 L/h | 60s |
| Circulateur primaire | 1% | 60s |
| Nb cycles compresseur | 1 | 5 min |
...
- Consigne température départ eau primaire (°C)
...
Toutes les trames commencent par le magic bytes `0x55 0x00`.# Arkteos Proxy — Home Assistant Addon
